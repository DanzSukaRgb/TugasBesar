        ...
        <div class="card-body">
            ...
            <form action="{{ route('laporan.penjualan') }}" method="GET" class="row">
                ...
                <div class="col-12 d-flex justify-content-between">
                    ...
                    <a href="{{ route('laporan.export-pdf') }}?tanggal_mulai={{ request('tanggal_mulai', date('Y-m-01')) }}&tanggal_akhir={{ request('tanggal_akhir', date('Y-m-d')) }}&kasir_id={{ request('kasir_id', '') }}" class="btn btn-danger" target="_blank">
    ...
    <div class="card border-0 shadow">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <h5 class="text-primary mb-0">Total: Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</h5>
            </div>
