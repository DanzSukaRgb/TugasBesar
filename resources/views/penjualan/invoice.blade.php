...
<head>
    ...
    <link rel="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/fontawesome.min.css">
    <style>
        body {
        ...
        .invoice-box table td, .table-box table, th table {
            padding: 10px;
            vertical-align: top;
        }
        .invoice-box .header {
...
<body>
    <div class="invoice-box animate-zoom-in">
    ...
    <script>
        ...
        function downloadPDF() {
            ...
            const opt = {
                margin: 10,
                filename: `Invoice_${{ $penjualan->id }}.pdf`,
