                ...
                <div class="card-body">
                    <form action="{{ route('barang.store') }}" method="POST" enctype="multipart/form-data" id="barangForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga" name="harga" value="{{ old('harga', 0) }}" min="0" step="1" required>
                            @error('harga')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
        ...
        $('#gambar').change(function() {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    ...
                    $('#gambar').siblings('.image-preview').remove();
